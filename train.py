...
def draw_curces(matrix, epoch, path):
    ...
    plt.plot(x, np.array(matrix[0])[:, 3], 'y-o', label = 'rose')
    ...
    plt.plot(x, np.array(matrix[1])[:, 3], 'y-o', label = 'rose')
    ...
    plt.plot(x, np.array(matrix[2])[:, 3], 'y-o', label = 'rose')
    ...
    plt.plot(x, np.array(matrix[4])[:, 3], 'y-o', label = 'rose')
    ...
    plt.plot(x, np.array(matrix[5])[:, 3], 'y-o', label = 'rose')
    ...
    plt.plot(x, np.array(matrix[6])[:, 3], 'y-o', label = 'rose')
    ...
    #test loss
    plt.plot(x, np.array(matrix[7]), 'r', label = 'training loss')
